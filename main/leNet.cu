    ...
    for(int epoch = 0; epoch < epoch_dim; epoch++){
        for(int batch = 0; batch < batch_dim; batch++){
            ...
            */
            ...
            max_third_dim = min(kernel_num_first_layer, (unsigned int)((1024.0 * 48.0 / sizeof(float) - (in_w * in_h * 1)) / (kernel_dim * kernel_dim * 1)));
            ...
            */
            ...
            max_third_dim = min(kernel_num_second_layer, (unsigned int)((1024.0 * 48.0 / sizeof(float) - (in_w * in_h * kernel_num_first_layer)) / (kernel_dim * kernel_dim * kernel_num_first_layer)));
            ...
            */
            ...
            max_third_dim = min(kernel_num_third_layer, (unsigned int)((1024.0 * 48.0 / sizeof(float) - (in_w * in_h * kernel_num_second_layer)) / (kernel_dim * kernel_dim * kernel_num_second_layer)));
